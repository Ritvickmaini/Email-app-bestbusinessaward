            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  Mark<br/>
                  Show Director<br/>
                  <a href="mailto:mark@bestbusinessawards.org"
                     style="color:#D7262F">mark@bestbusinessawards.org</a><br/>
                </p>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.bestbusinessawards.org", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="mark@bestbusinessawards.org")
